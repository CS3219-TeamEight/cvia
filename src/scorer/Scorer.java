...
public class Scorer {
    ...
    private void setdegreeMultiplier() {
        degreeMultiplier.put("Ph.D", 2.5);
        degreeMultiplier.put("Master", 2.0);
        degreeMultiplier.put("Honors", 1.5);
        degreeMultiplier.put("Bachelor", 1.0);
        degreeMultiplier.put("UNKNOWN", 1.0);
    }
